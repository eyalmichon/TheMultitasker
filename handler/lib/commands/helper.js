...
const help = {
    ...
    Info: {
        ...
        imagine: `${b('Usage:')} ${prefix}imagine [text] (where text is the text you want to come to life.)\n\n${b('Options:')}\n• Enhance: (-enhance) Whether to enhance the image or not. Default: false.\n• Quality: (-quality=[25-150]) Default: 25.\n• Freedom: (-freedom=[0-30])(float) the level of freedom (or strictness) you allow when creating from your prompt. Higher values force to follow your prompt. Default: 7.5.\n• Ratio: (-ratio=[1-5]) The aspect ratio of the image.\n1: Cinema 16:9, 2: Landscape 3:2, 3: Square 1:1, 4: Tablet 2:3, 5: Phone 9:16.\nDefault: 1 (square).\n• Image: (-image and tag an image or -image and a link of an image) The image to start the creation from.\n• Strength: (-strength=[0-1]) The strength of the image.\n• Negative Prompt: (-neg="prompt here") a description of what you do *not* want in the image - will stay away from concepts in the negative prompt.${b('Aliases:')}\n[imagine]`,
    },
    Sticker: {
